...
var paths = {
	"ConnectSDK_Repository": "https://github.com/terrabythia/Connect-SDK-Cordova-Plugin.git",
...
AndroidInstall.prototype.cloneConnectSDK = function () {
	...
	.then(function () {
		return Q.nfcall(exec, "git checkout", {cwd: safePath("./cordova-plugin-connectsdk/" + csdkDirectory)});
	})
	.then(function () {
